          ...
          <div className="row">
            ...
            <div className="col-lg-2 col-md-6 col-12">
              ...
              <div className="single-footer links">
                ...
                <ul>
                  <li><a to="/">Payment Methods</a></li>
                  <li><a to="/">Money-back</a></li>
            ...
            <div className="col-lg-3 col-md-6 col-12">
              ...
              <div className="single-footer social">
                ...
                {/* End Single Widget */}
                <ul>
                  <li><a to="/"><i className="ti-facebook" /></a></li>
                  <li><a to="/"><i className="ti-twitter" /></a></li>
                  <li><a to="/"><i className="ti-flickr" /></a></li>
                  <li><a to="/"><i className="ti-instagram" /></a></li>
                </ul>
              </div>
              {/* End Single Widget */}
            </div>
            ...
            <div className="row">
              <div className="col-lg-6 col-12">
                <div className="left">
                  <p>
                    Copyright © 2020
                    <a href="http://www.wpthemesgrid.com" target="_blank" rel="noreferrer">Wpthemesgrid</a>
                    {' '}
                    -  All Rights Reserved.
                  </p>
                </div>
